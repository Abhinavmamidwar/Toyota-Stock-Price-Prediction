...
# 1. PAGE SETUP
st.set_page_config(page_title="Toyota AI Forecast", page_icon="🚗", layout="wide")
...
try:
    ...
    st.title("📈 Toyota Motor Corp (TM) - AI Analytics Dashboard")
    ...
    # ROW 2: GRAPH
    st.subheader("📊 Price Trend & AI Forecast")
    ...
    st.markdown("---")
    st.subheader("🔮 Next Trading Day Intelligence")
    ...
    with c1:
        ...
        if tomorrow_price > last_price:
            st.success("📈 BULLISH TREND EXPECTED")
        else:
            st.warning("📉 BEARISH TREND EXPECTED")
